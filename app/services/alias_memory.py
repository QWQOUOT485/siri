...
class AliasMemory:
    ...
    def __init__(self, database: SemanticMemoryDatabase, normalizer: EntityNormalizer | None = None) -> None:
    ...
    def lookup_exact(self, value: str | NormalizedEntityText) -> AliasCandidate | None:
        ...
        if normalized is None:
            return None
        with self._lock:
            return self._exact_index.get(normalized.canonical_text) or self._exact_index.get(normalized.compact_text)
