...
from .semantic_grounder import (
    contains_explicit_version_marker,
    contains_forbidden_authority,
    contains_unresolved_reference,
)
...
class SemanticRetryEligibilityGate:
    ...
    def evaluate(
        ...
        *,
        ...
        if contains_explicit_version_marker(raw):
            return AIEligibility(False, "version_marker_requires_deterministic_parser")
