...
class CommandParser:
    ...
    def parse(self, text: str) -> ParsedCommand:
        ...
        exact = {
            ...
            "暫停音樂": ActionName.SPOTIFY_PAUSE,
            "暂停": ActionName.SPOTIFY_PAUSE,
            "暂停音乐": ActionName.SPOTIFY_PAUSE,
            "pause": ActionName.SPOTIFY_PAUSE,
            "pause music": ActionName.SPOTIFY_PAUSE,
            "spotify pause": ActionName.SPOTIFY_PAUSE,
            "下一首歌": ActionName.SPOTIFY_NEXT,
            "next track": ActionName.SPOTIFY_NEXT,
            "next": ActionName.SPOTIFY_NEXT,
            "spotify next": ActionName.SPOTIFY_NEXT,
            "上一首歌": ActionName.SPOTIFY_PREVIOUS,
            ...
            "打亂播放": ActionName.SPOTIFY_SHUFFLE_ON,
            "shuffle on": ActionName.SPOTIFY_SHUFFLE_ON,
            "spotify shuffle on": ActionName.SPOTIFY_SHUFFLE_ON,
            "不要隨機": ActionName.SPOTIFY_SHUFFLE_OFF,
            "關閉隨機播放": ActionName.SPOTIFY_SHUFFLE_OFF,
            "shuffle off": ActionName.SPOTIFY_SHUFFLE_OFF,
            "spotify shuffle off": ActionName.SPOTIFY_SHUFFLE_OFF,
            "單曲循環": ActionName.SPOTIFY_REPEAT_TRACK,
            "重複這首": ActionName.SPOTIFY_REPEAT_TRACK,
            "一直重複這首": ActionName.SPOTIFY_REPEAT_TRACK,
            "repeat this track": ActionName.SPOTIFY_REPEAT_TRACK,
            "循環播放": ActionName.SPOTIFY_REPEAT_CONTEXT,
            "循環播放清單": ActionName.SPOTIFY_REPEAT_CONTEXT,
            "循環這張專輯": ActionName.SPOTIFY_REPEAT_CONTEXT,
            "循環這個播放清單": ActionName.SPOTIFY_REPEAT_CONTEXT,
            "repeat playlist": ActionName.SPOTIFY_REPEAT_CONTEXT,
            "repeat context": ActionName.SPOTIFY_REPEAT_CONTEXT,
            "不要重複": ActionName.SPOTIFY_REPEAT_OFF,
            "不要循環": ActionName.SPOTIFY_REPEAT_OFF,
            "關閉循環": ActionName.SPOTIFY_REPEAT_OFF,
            "取消循環": ActionName.SPOTIFY_REPEAT_OFF,
            "repeat off": ActionName.SPOTIFY_REPEAT_OFF,
            "就一直播下去": ActionName.SPOTIFY_CONTINUE,
            "正常播就好": ActionName.SPOTIFY_CONTINUE,
            "照順序繼續播": ActionName.SPOTIFY_CONTINUE,
            "繼續正常播放": ActionName.SPOTIFY_CONTINUE,
            "continue normally": ActionName.SPOTIFY_CONTINUE,
            "keep playing normally": ActionName.SPOTIFY_CONTINUE,
            "靜音": ActionName.MUTE,
